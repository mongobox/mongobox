...
namespace Emk\Bundle\TumblrBundle\Controller\Admin;
...
class TumblrController extends Controller
{
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EmkTumblrBundle:Tumblr')->find($id);
     ...
     * @Method("POST")
     * @Template("EmkTumblrBundle:Tumblr:new.html.twig")
     */
     ...
     * @Method("POST")
     * @Template("EmkTumblrBundle:Tumblr:edit.html.twig")
     */
