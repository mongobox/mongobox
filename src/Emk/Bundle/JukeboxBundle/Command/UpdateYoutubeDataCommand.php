<?php
namespace Emk\Bundle\JukeboxBundle\Command;
...
// Handler
use Emk\Bundle\JukeboxBundle\Command\Monolog\Handler\CliHandler;
...
class UpdateYoutubeDataCommand extends ContainerAwareCommand
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $videos = $em->getRepository('EmkJukeboxBundle:Videos')->findBy(array('duration' => 0));
