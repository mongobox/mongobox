...
class VoteRepository extends EntityRepository
{
    public function wipe($id_video)
    {
        ...
        $query = $em
                ->createQuery('DELETE FROM EmkJukeboxBundle:Vote v WHERE v.video = :id_video' )
    ...
    public function sommeVotes($video)
    {
        $em = $this->getEntityManager();
        $query = $em
                ->createQuery('SELECT SUM(v.sens) FROM EmkJukeboxBundle:Vote v WHERE v.video = :id_video')
    ...
    public function sommeAllVotes()
    {
        $em = $this->getEntityManager();
        $query = $em
                ->createQuery('SELECT v, SUM(v.sens) as total FROM EmkJukeboxBundle:Vote v GROUP BY v.video')
                ;
        $result = $query->getResult();
        $somme = array();
        foreach ($result as $r) {
